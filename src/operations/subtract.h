#ifndef MATRIX_LIBRARY_OPERATIONS_SUBTRACT_H
#define MATRIX_LIBRARY_OPERATIONS_SUBTRACT_H
...
{
    template <class T>
    matrix_library::Tensor<T> subtract(const matrix_library::Tensor<T> &a, const matrix_library::Tensor<T> &b)
    {
        if (a.shape() != b.shape())
        {
